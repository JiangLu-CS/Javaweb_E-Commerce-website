...
public class GoodsDaoImpl extends BaseDao implements GoodsDao {
    ...
    public int update(Goods goods) {
        String sql="update goods set name=?,price=?,stock=?,img1=?,img2=?,img3=? where id=?";
        Object[]obj={goods.getName(),goods.getPrice(),goods.getStock(),goods.getImg1(),goods.getImg2(),goods.getImg3(),goods.getId()};
        return this.executeUpdate(sql, obj);
    }
    ...
    public int insert(Goods goods) {
        ...
        Object[]obj={goods.getId(),goods.getName(),goods.getPrice(),goods.getStock(),goods.getImg1(),goods.getImg2(),goods.getImg3(),null};
        return this.executeUpdate(sql, obj);
    }
}
