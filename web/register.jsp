...
<head>
    ...
    <style type="text/css">
        *{margin:0px;padding:0px;}
        ...
        #div2{background: url("img/bg.jpg") -80px -150px no-repeat;}
    ...
    <div id="div2">
        <form action="UserServlets?opr=reg" method="post">
            <table width="511px" cellspacing="4px" cellpadding="1px" style="margin-left:100px;" >
                ...
                <tr>
                    <td height="44" colspan="4" style="font-size:13px"><input  type="checkbox" checked="checked"/>我已阅读并同意<a href="#">《用户注册协议》</a></td>
                </tr>
                <tr>
