...
<c:if test="${empty list}">
    <%
        ...
        if(opr != null&&id != null){
            response.sendRedirect("GoodServlets?opr="+opr+"&id="+id);
        }else{
    ...
    <form action="CartServlet?opr=add&gid=${goods.getId()}&img=${goods.getImg1()}&name=${goods.getName()}&price=${goods.getPrice()}" method="post">
        <table width="500" cellspacing="4" cellpadding="1">
            ...
            <tr>
                ...
                <td style="text-decoration:line-through">￥999999</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr id="haha">
                ...
                <td colspan="2">
                    ...
                    <input type="radio" name="color" value="型号1" checked="checked"/>型号1
                    <input type="radio" name="color" value="型号2"/>型号2
                    <input type="radio" name="color" value="型号3"/>型号3
...
<div id="cuxiao">
    ...
    <a href="GoodServlets?opr=det&id=10104"><img src="img/手机1.jpg" /></a><br />
    <a href="GoodServlets?opr=det&id=10105"><img src="img/电脑1.jpg" /></a><br />
    <a href="GoodServlets?opr=det&id=10101"><img src="img/眼影.jpg" /></a><br />
    <a href="GoodServlets?opr=det&id=10102"><img src="img/眼影1.jpg" /></a>
</div>
